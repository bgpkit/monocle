//! File-based cache for RPKI data
//!
//! This module provides a simple file-based caching system for RPKI data.
//! The cache stores JSON files with timestamps encoded in filenames.
//!
//! # Cache File Naming
//!
//! Files are named with the pattern: `rpki_{source}_{date}_{timestamp}.json`
//! (date is optional, used for historical data)
//!
